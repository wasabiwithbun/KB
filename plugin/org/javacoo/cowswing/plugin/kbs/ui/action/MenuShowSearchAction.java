 ...
 * @version 1.0
 */
@Component("menuShowSearchAction")
public class MenuShowSearchAction extends AbstractAction{
	...
	public MenuShowSearchAction(){
		super(LanguageLoader.getString("Kbs.title"),ImageLoader.getImageIcon("CrawlerResource.kbsSearch"));
