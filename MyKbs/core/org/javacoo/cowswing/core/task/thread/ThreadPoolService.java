...
public class ThreadPoolService{
    ...
    /** 线程池大小 */ 
    private int poolSize = Constant.DEFAULT_POOL_SIZE;  
    ...
    public List<Task> invokeAll(List<ProcessorCallableThread> tasks) {
        return invokeAll(tasks, Constant.DEFAULT_TASK_TIMEOUT * tasks.size());
    }
    /**
    ...
    public void shutdown() {  
        if (executorService != null && !executorService.isShutdown()) {  
            try {  
                executorService.awaitTermination(Constant.DEFAULT_TASK_TIMEOUT, TimeUnit.MILLISECONDS);  
            } catch (InterruptedException e) {  
                e.printStackTrace();  
            }  
