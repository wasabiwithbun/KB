 ...
 *@version 1.0
 */
public abstract class AbstractCowSwingService<T extends CowSwingBaseBean,E,Q> implements ICowSwingService<T,Q>{
	...
	public final int insert(T t,String sqlMapId){
		...
		try {
			...
			t.getObserver().notifyEvents(t.getCowSwingEvent());
