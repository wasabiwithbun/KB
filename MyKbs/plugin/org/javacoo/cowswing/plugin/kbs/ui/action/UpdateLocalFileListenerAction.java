 ...
 * @version 1.0
 */
@Component("updateLocalFileListenerAction")
public class UpdateLocalFileListenerAction extends AbstractAction{
	...
	public UpdateLocalFileListenerAction(){
		super("",ImageLoader.getImageIcon("CrawlerResource.systemDataBaseEdit"));
		putValue(SHORT_DESCRIPTION, LanguageLoader.getString("Kbs.local_edit_local_listener"));
	}
	/* (non-Javadoc)
	...
	public void actionPerformed(ActionEvent e) {
		localTreeSearchPanel.getAddLocalDirListenerDialog().init(cowSwingMainFrame, Constant.OPTION_TYPE_MODIFY, LanguageLoader.getString("Kbs.local_edit_local_listener"));
