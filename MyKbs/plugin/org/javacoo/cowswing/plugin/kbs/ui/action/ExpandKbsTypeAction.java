 ...
 * @version 1.0
 */
@Component("expandKbsTypeAction")
@Scope("prototype")
public class ExpandKbsTypeAction extends AbstractAction{
	private static final long serialVersionUID = 1L;
	/**知识分类树*/
	private ITypeTree iTypeTreePanel;
	public ExpandKbsTypeAction(){
		super("",ImageLoader.getImageIcon("CrawlerResource.kbs_expand_all"));
		putValue(SHORT_DESCRIPTION, LanguageLoader.getString("Kbs.type_expand_all_btn"));
	}
	/* (non-Javadoc)
	...
	public void actionPerformed(ActionEvent e) {
		this.iTypeTreePanel.expandTree(true);
	}
	/**
