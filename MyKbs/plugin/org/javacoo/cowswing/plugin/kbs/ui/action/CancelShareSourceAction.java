 ...
 * @version 1.0
 */
@Component("cancelShareSourceAction")
public class CancelShareSourceAction  extends AbstractAction{
	...
	public CancelShareSourceAction(){
		super(LanguageLoader.getString("Kbs.module_source_cancle_share_btn"),ImageLoader.getImageIcon("CrawlerResource.kbs_cancel_share"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(moduleSourceTable.getSelectedRow() != -1){
			int result = JOptionPane.showConfirmDialog(null, LanguageLoader.getString("Kbs.module_source_cancel_share_info"),LanguageLoader.getString("Common.confirm"), JOptionPane.YES_NO_OPTION); 
			if(result == 0){
	...
	public void shareByResourceIdList(List<Integer> resourceIdList){
		...
		kbsModuleSourceBean.setPurview(KbsConstant.SEARCH_PURVIEW_PERSON);
