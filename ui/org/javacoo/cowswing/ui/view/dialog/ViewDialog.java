...
public class ViewDialog extends JDialog implements CowSwingListener{
...
//	private ContentDialog contentDialog;
	...
	public ViewDialog(){
		...
		setTitle(LanguageLoader.getString("Common.contentDetail"));
	...
	public void update(CowSwingEvent event) {
		if(event.getEventType().equals(CowSwingEventType.NetViewReturnEvent)){
			showContent(event.getEventObject().toString());
		}
	}
